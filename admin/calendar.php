							...
							<ul class="list-unstyled ct-cal-booking-details bkng-detl">
								...
								<li class="ct-bd-card ct-bd-service" style="width:100%;">
									...
									<ul class="list-unstyled ct-bd-grid">
										...
										<li class="ct-bd-full li_of_duration <?php if ($setting->get_option('ct_show_time_duration') == 'N') {echo "ct-bd-hidden";} ?>">
							    ...
							    <li class="ct-bd-card ct-bd-staff" style="width:100%;">
						...
						<div class="modal-footer">
							<div class="col-xs-12 np ct-footer-popup-btn text-center">
								<div class="fln-mrat-dib">
									...
									<span class="col-xs-4 np ct-w-32 myrescheduleclass">
										<a id="ct-reschedual-appointment" class="btn btn-link ct-small-btn rescedual_book ct-reschedual-appointment-cal" data-id="" title="Riprogramma"><i class="fa fa-repeat fa-2x"></i><br />Riprogramma</a>
									</span>
									<span class="col-xs-4 np ct-w-32 myrejectclass">
										<a id="ct-reject-appointment-cal-popup" data-id="" href="#" role="button" class="btn btn-link ct-small-btn ct-admin-reject-toggle" data-bkid="" title="Rifiuta"><i class="fa fa-thumbs-o-down fa-2x"></i><br />Rifiuta</a>
									</span>
									<span class="col-xs-4 np ct-w-32">
										<a id="ct-delete-appointment-cal-popup" href="#" role="button" class="ct-delete-appointment-cal-popup pull-left btn btn-link ct-small-btn book_cancel ct-admin-delete-toggle" data-id="" data-bkid="" title="<?php echo $label_language_values['delete_this_appointment']; ?>?"><i class="fa fa-trash-o fa-2x"></i><br /><?php echo $label_language_values['delete']; ?></a>
									</span>
									<!-- legacy popover template kept hidden for other screens -->
									<div id="popover-delete-appointment-cal-popup" class="popup_display_cancel" style="display: none;">
										<button id="delete_appt" value="Delete" data-id="" data-gc_event="" data-pid="" data-gc_staff_event="" class="btn btn-danger btn-sm delete_bookings delete_bookings_dash" type="button"><?php echo $label_language_values['delete']; ?></button>
										<button id="ct-close-del-appointment-cal-popup" class="btn btn-default btn-sm" type="button"><?php echo $label_language_values['cancel']; ?></button>
									</div>
								</div>
								<div class="ct-admin-inline-panel ct-admin-delete-panel" id="ct-admin-delete-panel" style="display:none;">
									<div class="ct-admin-inline-title"><?php echo $label_language_values['delete_this_appointment']; ?>?</div>
									<div class="ct-admin-inline-actions">
										<button type="button" id="ct-admin-delete-confirm" value="Delete" data-id="" data-gc_event="" data-pid="" data-gc_staff_event="" class="btn btn-danger btn-sm delete_bookings delete_bookings_dash"><?php echo $label_language_values['delete']; ?></button>
										<button type="button" class="btn btn-default btn-sm ct-admin-delete-dismiss"><?php echo $label_language_values['cancel']; ?></button>
									</div>
								</div>
								<div class="ct-admin-inline-panel ct-admin-reject-panel" id="ct-admin-reject-panel" style="display:none;">
									<div class="ct-admin-inline-title"><?php echo $label_language_values['appointment_reject_reason']; ?></div>
									<textarea class="form-control reject_rea_appt" id="reason_reject" name="" placeholder="<?php echo $label_language_values['appointment_reject_reason']; ?>" required="required"></textarea>
									<div class="ct-admin-inline-actions">
										<button id="reject_appt" data-gc_event="" data-pid="" data-gc_staff_event="" value="Delete" class="btn btn-danger btn-sm reject_bookings" data-id="" type="button">Rifiuta</button>
										<button type="button" class="btn btn-default btn-sm ct-admin-reject-dismiss"><?php echo $label_language_values['cancel']; ?></button>
									</div>
								</div>
							</div>
						</div>
